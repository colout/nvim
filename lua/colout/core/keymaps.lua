...
-- general
keymap.set("n", "<leader>nh", ":nohl<CR>") -- no hilights

keymap.set("n", "x", '"_x') -- don't yank to registry when 'x' on single character

keymap.set("n", "<leader>+", "<C-a>") -- increment current number
keymap.set("n", "<leader>-", "<C-x>") -- decrement current number
